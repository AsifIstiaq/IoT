...
// =====================================================================
//  web_interface.h — WiFi AP, HTML control page, REST endpoints.
//  The ESP32 hosts its own access point so no external router is
//  needed for the demo (192.168.4.1 once connected to "WaiterRobot").
// =====================================================================
...
inline void handleGoto() {
  ...
  if (started) {
    lastStateChangeTime = millis(); // Reset the blind window timer on a fresh command
  }
